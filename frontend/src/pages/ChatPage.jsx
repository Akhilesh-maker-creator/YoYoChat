...
import { Image, Send, X, ArrowLeft, Loader2, Video } from "lucide-react";
...
const chatId = getChatId(selectedUser?._id, authUser?._id);
    ...
    return (
      <div className="h-screen flex items-center justify-center bg-base-200">
        <div className="alert alert-error max-w-md">
          <span>
            Error: {getMessagesError?.message || getUserError?.message}
          </span>
          ...
          <div className="bg-base-100 p-3 border-t border-base-300">
            ...
            <form onSubmit={handleSubmit} className="flex items-end gap-2">
              ...
              <button
                type="submit"
                disabled={
                  isSending || (!messageData.text.trim() && !messageData.image)
                }
